...
import { Flame, Download, Calendar } from 'lucide-react';
...
export default function Header({ 
  ...
  return (
    <header className="w-full max-w-[1380px] mx-auto px-6 sm:px-10 pt-8 pb-4 flex items-center justify-between">
      
      {/* Brand */}
      <div className="flex items-center gap-3.5">
        <div className="w-12 h-12 rounded-xl bg-[#FDC800] border-2 border-black flex items-center justify-center font-display font-black text-2xl text-black shadow-[3px_3px_0px_#000000]">
          ⚡
        </div>
        <div>
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className={`px-4 py-2 rounded-xl border-2 border-black text-black text-xs font-mono font-black flex items-center gap-2 shadow-[3px_3px_0px_#000000] hover:translate-x-[-1px] hover:translate-y-[-1px] hover:shadow-[4px_4px_0px_#000000] active:translate-x-[2px] active:translate-y-[2px] active:shadow-[1px_1px_0px_#000000] transition-all cursor-pointer ${
