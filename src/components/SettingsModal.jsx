...
export default function SettingsModal({
  ...
  // 🛡️ Storage Tier Sovereignty State (Local Storage vs Persistent Shield)
  ...
  const [storageTierMsg, setStorageTierMsg] = useState('');

  const refreshStorageTier = () => {
        ...
        >
          ...
          >
            ...
            <div className="space-y-3.5 overflow-y-auto overflow-x-hidden flex-1 pr-1">              {/* 1. Notifications & Reminder Time */}
              ...
              {/* BEHAVIORAL TRILOGY MATRIX (OFF BY DEFAULT) */}
                            ...
                            <form key={sphere.id} onSubmit={handleSaveEditSphere} className="p-3.5 bg-amber-50 border-2 border-black rounded-xl space-y-2.5">
                              <div className="flex items-center justify-between">
                                ...
                                <button
                                  ...
                                  className="p-0.5 text-neutral-500 hover:text-black cursor-pointer"
                                >
                      ...
                      <form onSubmit={handleAddCustomSphere} className="p-3 bg-neutral-100 rounded-xl border-2 border-black space-y-2.5">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <input
                            ...
                            className="w-14 text-center px-1 py-1.5 text-xs font-mono font-bold border-2 border-black rounded-xl bg-white focus:outline-none"
                            title="Sphere icon"
                          />
                        </div>
