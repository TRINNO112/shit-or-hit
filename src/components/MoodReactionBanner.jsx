...
const MOOD_CONFIG = {
  1: {
    ...
    gradientClass: 'bg-linear-to-r from-[#FF4D4D] via-[#FF3B30] to-[#DC2626]',
  ...
  2: {
    ...
    gradientClass: 'bg-linear-to-r from-[#FF8A00] via-[#FF7A00] to-[#EA580C]',
  ...
  3: {
    ...
    gradientClass: 'bg-linear-to-r from-[#E2E8F0] via-[#CBD5E1] to-[#94A3B8]',
    textColor: 'text-black',
  ...
  4: {
    ...
    gradientClass: 'bg-linear-to-r from-[#00E599] via-[#10B981] to-[#059669]',
    textColor: 'text-black',
  ...
  5: {
    ...
    gradientClass: 'bg-linear-to-r from-[#FDC800] via-[#FBBF24] to-[#F59E0B]',
    textColor: 'text-black',
