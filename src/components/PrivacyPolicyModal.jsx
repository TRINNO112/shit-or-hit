      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/60 backdrop-blur-xs overflow-y-auto">
        ...
        >
          ...
          <div className="mt-6 pt-4 border-t-2 border-black flex justify-end">
            <button
              onClick={onClose}
              className="px-5 py-2.5 bg-[#00E599] text-black font-black uppercase tracking-wider border-2 border-black shadow-[3px_3px_0px_#000000] hover:translate-x-px hover:translate-y-px hover:shadow-[2px_2px_0px_#000000] transition-all flex items-center gap-2 text-xs sm:text-sm cursor-pointer"
            >
